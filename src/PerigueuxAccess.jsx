...
export default function PerigueuxAccess() {
  ...
  return (
    <div style={{
      ...
      {/* ============================================================ */}
      {/* 🗺️ CONTENEUR CARTE — TOUJOURS dans le DOM                   */}
      {/* Jamais détruit = Leaflet fonctionne toujours                 */}
      {/* ============================================================ */}
      <div
        ref={mapRef}
        style={{
          position: 'fixed',
          top: 68, // sous le header
          left: 0, right: 0,
          bottom: 68, // au-dessus de la nav
          zIndex: view === 'map' ? 5 : 1,
          background: '#e8e0d0',
          touchAction: 'none',
        }}
      ...
      {/* Filtres et barre de recherche — par-dessus la carte */}
      {view === 'map' && (
        <MapView
...
function MapView({ theme, fontDisplay, filters, setFilters, showFilters, setShowFilters, places, filteredPlaces, onSelectPlace, userLocation, locationStatus, onRequestLocation, onDisableLocation, profile, onToggleFavorite, onRecenter, dark }) {
  ...
  return (
    <div style={{
      position: 'relative',
      zIndex: 10,
      pointerEvents: 'none', // L'overlay ne bloque pas les clics sur la carte
    }}>
      {/* Panneau filtres/recherche */}
      <div style={{
        padding: '14px 20px 10px',
        background: dark ? 'rgba(26,22,18,0.90)' : 'rgba(245,239,224,0.90)',
        backdropFilter: 'blur(6px)',
        WebkitBackdropFilter: 'blur(6px)',
        borderBottom: `1px solid ${theme.border}`,
        pointerEvents: 'auto', // ce panneau capte les clics
      }}>
