  ...
  useEffect(() => {
    ...
    const loadLeaflet = async () => {
      ...
      if (!mapInstance.current) {
        // Première initialisation — attendre que le DOM soit vraiment prêt
        setTimeout(() => {
          initMap();
          // Double invalidateSize pour forcer Leaflet à calculer les bonnes dimensions
          setTimeout(() => {
            if (mapInstance.current) {
    ...
    <div>
      ...
      <div style={{position: 'relative'}}>
        <div
          ref={mapRef}
          style={{
            height: 'calc(100dvh - 260px)', // dvh = dynamic viewport height, meilleur sur mobile
            minHeight: 350,
            width: '100%',
            touchAction: 'none',
            cursor: 'grab',
            background: '#e8e0d0', // Fond neutre pendant le chargement
          }}
        />
        {userLocation && (
          <button
